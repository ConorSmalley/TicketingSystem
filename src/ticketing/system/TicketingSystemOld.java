 ...
 * @author Conor
 */
public class TicketingSystemOld extends javax.swing.JFrame {

    UserAccountManager uam;

    public TicketingSystemOld() {
        uam = UserAccountManager.getInstance();
        try {
            Deserialize();
        } catch (IOException ex) {
            Logger.getLogger(TicketingSystemOld.class.getName()).log(Level.SEVERE, null, ex);
...
//        }
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jLabelActiveUser, javax.swing.GroupLayout.PREFERRED_SIZE, 84, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketingSystemOld.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketingSystemOld().setVisible(true);
            }
        });
    }
